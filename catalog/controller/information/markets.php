<?php
class ControllerInformationMarkets extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('information/dilers')
		);
		...
		$data['action'] = $this->url->link('information/dilers', '', true);
		...
		$this->response->setOutput($this->load->view('information/markets', $data));
	}
