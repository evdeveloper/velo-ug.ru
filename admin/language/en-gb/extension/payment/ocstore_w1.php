<?php
// Heading
$_['heading_title']           = 'W1 - Единая Касса';
...
// Entry
$_['entry_shop_id']               = 'Идентификатор (номер кассы) магазина';
$_['entry_sign']                  = 'Секретный ключ магазина';
$_['entry_currency']              = 'Валюта платежа';
$_['entry_result_url']            = 'URL скрипта';
$_['entry_ecp']                   = 'Метод формирования ЭЦП<br />';
...
$_['error_shop_id']         = 'Поле "Идентификатор (номер кассы) магазина" должно быть заполнено!';
$_['error_sign']            = 'Поле "Секретный ключ магазина" должно быть заполнено!';
?>