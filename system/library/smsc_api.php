...
protected $smslogin = ''; // логин клиента
protected $smspassword = ''; // пароль
protected $smsfrom = ''; // e-mail адрес отправителя
protected $smspost = 0; // использовать метод POST
protected $smshttps = 0; // использовать HTTPS протокол
protected $smscharset = "windows-1251"; // кодировка сообщения: utf-8, koi8-r или windows-1251 (по умолчанию)
protected $smsdebug = 0; // флаг отладки
